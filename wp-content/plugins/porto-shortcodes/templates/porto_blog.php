...
if ($posts->have_posts()) {
    ...
    <div class="<?php if ($post_layout == 'timeline') echo 'm-t-n-xxl'; else echo 'push-top'; ?> m-b-xxl text-center">
        <a class="button<?php echo $view_more_class ? ' ' . str_replace('.', '', $view_more_class) : '' ?>" href="<?php echo get_permalink( get_option('page_for_posts' ) ) ?>"><?php _e("View More", 'porto-shortcodes') ?></a>
    </div>
    <?php endif; ?>
