...
@body_mobile_letter_spacing: <?php echo $b['body-mobile-font']['letter-spacing'] ?>;
...
@h2_letter_spacing: <?php echo $b['h2-font']['letter-spacing'] ?>;
...
@h3_letter_spacing: <?php echo $b['h3-font']['letter-spacing'] ?>;
...
@h4_letter_spacing: <?php echo $b['h4-font']['letter-spacing'] ?>;
...
@h5_letter_spacing: <?php echo $b['h5-font']['letter-spacing'] ?>;
...
@menu_letter_spacing: <?php echo $b['menu-font']['letter-spacing'] ?>;
...
@menu_side_letter_spacing: <?php echo $b['menu-side-font']['letter-spacing'] ?>;
...
@menu_popup_letter_spacing: <?php echo $b['menu-popup-font']['letter-spacing'] ?>;
...
@mobile_menu_toggle_bg_color: <?php echo $b['mobile-menu-toggle-bg-color'] ?>;
...
@header_top_menu_padding_top: <?php echo porto_config_value($b['header-top-menu-padding']['padding-top']) ?>px;
...
@sticky_menu_bg_color: <?php if($b['mainmenu-wrap-bg-color-sticky'] && $b['mainmenu-wrap-bg-color-sticky'] != 'transparent') echo $b['mainmenu-wrap-bg-color-sticky']; else if ($b['mainmenu-bg-color'] && $b['mainmenu-bg-color'] != 'transparent') echo $b['mainmenu-bg-color']; else if ($b['mainmenu-wrap-bg-color'] && $b['mainmenu-wrap-bg-color'] != 'transparent') echo $b['mainmenu-wrap-bg-color']; else echo $b['sticky-header-bg']['background-color'] ?>;
...
@footer_label_color: <?php echo $b['footer-label-color'] ?>;
